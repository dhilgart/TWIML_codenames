...
def generate_guesses(game_id, team_num, clue_word, clue_count, unguessed_words, boardwords, boardmarkers):
    ...
    ### modified guess from paper: Cooperation and Codenames:Understanding Natural Language Processing via Codenames

    # 
    threshold_for_guessing = 0.2

    guesses = []
    for clue_num in range(clue_count):
        best = None
        d = float('Inf')       
